...
wgan = wg.WGANGP(latent_dim=64, target_shape=(64, 128, 82), batch_size=4,
                 optimizerG=None, optimizerC=None, summary=True, n_critic=5,
                 models=None, gradient_penalty=10, data=X_train, tfboard=False)

wgan.train(epochs=5, save_interval=4, save_file='padd_perio',
