...
def identity_block(X, f, filters, stage, block):
    ...
    X = Conv2D(filters = F1, kernel_size = (3, 3), strides = (1,1), padding = 'valid', name = conv_name_base + '2a', kernel_initializer = glorot_uniform(seed=0))(X)
    ...
    X = Conv2D(filters = F3, kernel_size = (3, 3), strides = (1, 1), padding = 'valid', name = conv_name_base + '2c', kernel_initializer = glorot_uniform(seed=0))(X)
...
def convolutional_block_down(X, f, filters, stage, block, s=2):
    ...
    ##### SHORTCUT PATH #### 
    X_shortcut = AveragePooling2D(pool_size=(2, 2), strides=None, padding='valid', data_format=None)(X_shortcut)
    X_shortcut = Conv2D(filters=F3, kernel_size=(1, 1), strides=(1, 1), padding='valid',
